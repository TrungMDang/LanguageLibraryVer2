...
public class HomePanel extends JPanel {
    ...
    public HomePanel() {
        ...
        internalFrame.setBackground(new Color(204, 204, 255));//204, 204, 255
        internalFrame.getContentPane().setFont(new Font("Comic Sans MS", Font.PLAIN, 11));
        internalFrame.getContentPane().setBackground(new Color(242,247,242));
                                                     
        internalFrame.setBounds(-34, -26, 810, 600);
        add(internalFrame);
        ...
        CCSLogo.setBounds(250, 219, 323, 179);
        ...
        namesLabel.setBounds(60, 396, 714, 63);
